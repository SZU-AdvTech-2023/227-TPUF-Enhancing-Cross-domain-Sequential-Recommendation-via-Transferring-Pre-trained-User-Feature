...
TPUF.dataset=Amazon_book.epoch=400.lr=0.001.hidden=32.maxlen=50.l2=0.5.loss_w0.8.combine_w0.5_HR_0.2113.pth",
                    type=str)
parser.add_argument('--model', default='SASRec', type=str)  # SASRec
...
if __name__ == '__main__':
    ...
    [user_train, user_valid, user_test, user_neg, usernum, itemnum] = dataset
    ...
    for epoch in range(epoch_start_idx, args.num_epochs + 1):
        ...
        if epoch % 20 == 0:
            ...
            t_valid = evaluate_valid(model, dataset, args, valid_user, valid_candidates)
